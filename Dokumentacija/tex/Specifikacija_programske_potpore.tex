\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Sekvencijski dijagrami}
				...
				\noindent Organizator nakon odabira opcije "Upravljanje". Poslužitelj dohvaća popis kampova iz baze podataka te ih prikazuje organizatoru. Organizator odabire kamp. Zatim odabire opciju "Aktivnosti", te nakon nje opciju "Unos aktivnosti". Organizator unosi podatke za novu aktivnost, koje poslužitelj šalje bazi podataka. Ukoliko unesena aktivnost već postoji, poslužitelj obavještava organizatora o tome. 
				\begin{figure}[H]
					\centerline{\includegraphics[width=\linewidth]{slike/UC20 - Unos aktivnosti.png}}
