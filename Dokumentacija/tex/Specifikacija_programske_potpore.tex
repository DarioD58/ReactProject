\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Organizator odabire opciju "Unos grupe"
							\item Organizator upisuje podatke za definiciju grupe te može pridružiti proizvoljan broj sudionika 
							\item Organizator odabire opciju "Potvrdi"
							\item Baza podataka se ažurira
						\end{packed_enum}
						...
						\item[] \begin{packed_item}
							...
							\item[3.a] Organizator odustaje od unosa grupe
							\item[] \begin{packed_enum}
								
								\item Sustav obavještava organizatora da grupa neće biti unesena u sustav
								
							\end{packed_enum}
							
							\item[6.a] Grupa koju je organizator unio već postoji u sustavu
							\item[] \begin{packed_enum}
								
								\item Sustav obavještava organizatora da grupa već postoji u sustavu
								\item Korisnik mijenja podatke ili odustaje od unosa grupe u sustav 
								
								
							\end{packed_enum}
							\item[6.b] Organizator nije unio sve potrebne podatke za definiciju grupe
							\item[] \begin{packed_enum}
								
								\item Sustav obavještava organizatora o podatcima koje mora unijeti
								\item Organizator unosi podatke ili odustaje od unosa grupe u sustav
			...
			\subsubsection{Dijagrami obrazaca uporabe}
				\begin{figure}[H]
					\centerline{\includegraphics[width=\columnwidth, height=0.9\textheight]{slike/UC_organizator.png}}
